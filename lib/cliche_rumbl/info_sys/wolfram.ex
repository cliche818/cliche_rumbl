defmodule ClicheRumbl.InfoSys.Wolfram do
  import SweetXml
  alias ClicheRumbl.InfoSys.Result
  ...
  defp fetch_xml(query_str) do
    {:ok, {_,_,body}} = :httpc.request(
      String.to_char_list("https://api.wolframalpha.com/v2/query" <>
        "?appid=#{app_id()}" <>
  ...
  defp app_id, do: Application.get_env(:cliche_rumbl, :wolfram)[:app_id]
end